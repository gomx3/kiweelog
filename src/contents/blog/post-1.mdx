---
title: '[Vite/React/TS] Proxy 설정으로 CORS 우회 (env 환경 변수)'
pubDate: 2025-05-31
description: 'This is the first post of my new Astro blog.'
author: 'gomx3'
image:
    url: '/images/cors-proxy/cat.png'
    alt: 'This is catnail'
tags: ['Vite', 'React', 'TS', 'CORS', 'Proxy']
---

학회 웹 페이지 퀴즈 관련 API를 연결하던 중 CORS 에러를 마주했다.

![CORS 오류 메시지](/public/images/cors-proxy/cors.png)
...
![CORS 오류 해결!](/public/images/cors-proxy/complete.png)
